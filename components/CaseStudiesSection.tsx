                ...
                <div className="space-y-6">
                  <div className="space-y-2">
                    <div className="flex items-center space-x-2">
                      ...
                      <span className="text-accent-400 font-medium">{study.client}</span>
                    </div>
                    <h3 className="text-2xl font-medium text-white">{study.title}</h3>
                  </div>

                  {/* Путь клиента */}
                  <div className="space-y-4">
                    <div className="space-y-2">
                      <h4 className="text-white font-medium">Задача:</h4>
                      <p className="text-neutral-300">{study.task}</p>
                    </div>
                    <div className="space-y-2">
                      <h4 className="text-white font-medium">Процесс:</h4>
                      <p className="text-neutral-300">{study.process}</p>
                    </div>
                    <div className="space-y-2">
                      <h4 className="text-white font-medium">Результат:</h4>
                  ...
                  <div className="space-y-3">
                    <h4 className="text-white font-medium">Что получил:</h4>
                  ...
                  {/* Отзыв */}
                  <div className="bg-background-surface/50 border border-neutral-800 rounded-lg p-4">
                    <div className="flex items-center space-x-2 mb-2">
                      ...
                      <span className="text-neutral-400 text-sm">{study.rating}/5</span>
                    </div>
                    <p className="text-neutral-300 text-sm italic">"{study.testimonial}"</p>
                  </div>
                </div>

                {/* Правая колонка - до/после */}
                <div className="space-y-4">
                  <h4 className="text-white font-medium">До/После:</h4>
                  <div className="grid grid-cols-2 gap-4">
                    <div className="space-y-2">
                      <span className="text-neutral-400 text-sm">До:</span>
                      <div className="aspect-[4/3] bg-gradient-to-br from-neutral-600/20 to-neutral-700/20 rounded-lg border border-neutral-600/30 flex items-center justify-center">
                        <span className="text-neutral-400 text-sm">Фото до</span>
                      </div>
                    </div>
                    <div className="space-y-2">
                      <span className="text-neutral-400 text-sm">После:</span>
                      <div className="aspect-[4/3] bg-gradient-to-br from-accent-500/20 to-accent-600/20 rounded-lg border border-accent-500/30 flex items-center justify-center">
                        <span className="text-accent-400 text-sm">Фото после</span>
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <div className="text-center space-y-4">
              ...
              <div className="grid md:grid-cols-3 gap-4 mt-8">
                <div className="text-center space-y-2">
                  <div className="text-3xl font-light text-accent-500">50+</div>
                  <div className="text-neutral-400 text-sm">Реализованных проектов</div>
                </div>
                <div className="text-center space-y-2">
                  <div className="text-3xl font-light text-accent-500">95%</div>
                  <div className="text-neutral-400 text-sm">Клиентов заказывают мебель</div>
                </div>
                <div className="text-center space-y-2">
                  <div className="text-3xl font-light text-accent-500">4.9</div>
                  <div className="text-neutral-400 text-sm">Средняя оценка</div>
                </div>
              </div>
            </div>
          </div>
