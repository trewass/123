...
const projectsData = {
  'house-urozhaynoe': {
    ...
    images: [
      { id: 1, type: 'image', alt: 'Кухня', src: '/api/images/Большой/main.jpg' },
      { id: 2, type: 'image', alt: 'Вид сверху', src: '/api/images/Большой/Page2.jpg' },
      { id: 3, type: 'image', alt: 'Розетки рабочей зоны', src: '/api/images/Большой/Page3.jpg' },
      { id: 4, type: 'image', alt: 'Схема розеток кухня', src: '/api/images/Большой/Page4.jpg' },
      { id: 5, type: 'image', alt: 'Лист проекта 5', src: '/api/images/Большой/Page5.jpg' },
      { id: 6, type: 'image', alt: 'Лист проекта 6', src: '/api/images/Большой/Page6.jpg' },
      { id: 7, type: 'image', alt: 'Лист проекта 7', src: '/api/images/Большой/Page7.jpg' },
      { id: 8, type: 'image', alt: 'Лист проекта 8', src: '/api/images/Большой/Page8.jpg' },
      { id: 9, type: 'image', alt: 'Лист проекта 9', src: '/api/images/Большой/Page9.jpg' },
      { id: 10, type: 'image', alt: 'Лист проекта 10', src: '/api/images/Большой/Page10.jpg' },
      { id: 11, type: 'image', alt: 'Лист проекта 11', src: '/api/images/Большой/Page11.jpg' },
      { id: 12, type: 'image', alt: 'Лист проекта 12', src: '/api/images/Большой/Page12.jpg' },
      { id: 13, type: 'image', alt: 'Лист проекта 13', src: '/api/images/Большой/Page13.jpg' },
      { id: 14, type: 'image', alt: 'Лист проекта 14', src: '/api/images/Большой/Page14.jpg' },
      { id: 15, type: 'image', alt: 'Лист проекта 15', src: '/api/images/Большой/Page15.jpg' },
      { id: 16, type: 'image', alt: 'Лист проекта 16', src: '/api/images/Большой/Page16.jpg' },
      { id: 17, type: 'image', alt: 'Лист проекта 17', src: '/api/images/Большой/Page17.jpg' },
      { id: 18, type: 'image', alt: 'Стена спальня', src: '/api/images/Большой/Page18.jpg' },
      { id: 19, type: 'image', alt: 'Стена 2', src: '/api/images/Большой/Page19.jpg' },
      { id: 20, type: 'image', alt: 'Шкаф спальня + электрика', src: '/api/images/Большой/Page20.jpg' },
      { id: 21, type: 'image', alt: 'Ванная комната электрика + вода + канализация', src: '/api/images/Большой/Page21.jpg' },
      { id: 22, type: 'image', alt: 'Ванная комната с мебелью', src: '/api/images/Большой/Page22.jpg' },
      { id: 23, type: 'image', alt: 'Сан Узел Вода + Канализация', src: '/api/images/Большой/Page23.jpg' },
      { id: 24, type: 'image', alt: 'Вид сверху Сан Узел', src: '/api/images/Большой/Page24.jpg' },
      { id: 25, type: 'image', alt: 'Сан узел 2 вода + канализация + электрика', src: '/api/images/Большой/Page25.jpg' },
      { id: 26, type: 'image', alt: 'Маленький Сан Узел мебель + вода + канализация', src: '/api/images/Большой/Page26.jpg' },
      { id: 27, type: 'image', alt: 'Электрика Сан Узел 2', src: '/api/images/Большой/Page27.jpg' },
      { id: 28, type: 'image', alt: 'Электрика морозильная камера', src: '/api/images/Большой/Page28.jpg' },
      { id: 29, type: 'image', alt: 'Вход в большой Сан Узел', src: '/api/images/Большой/Page29.jpg' },
      { id: 30, type: 'image', alt: 'Мебель в ванной комнате', src: '/api/images/Большой/Page29.jpg' },
      { id: 31, type: 'image', alt: 'Фото проекта 1', src: '/api/images/Большой/IMG_00002.jpg' },
      { id: 32, type: 'image', alt: 'Фото проекта 2', src: '/api/images/Большой/IMG_00003.jpg' }
    ]
  },
