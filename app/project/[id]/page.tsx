...
const projectsData = {
  'house-urozhaynoe': {
    ...
    images: [
      ...
      { id: 21, type: 'image', alt: 'Ванная комната электрика + вода + канализация', src: '/images/Большой проект. Пример/Page20.jpg' },
      { id: 22, type: 'image', alt: 'Ванная комната с мебелью', src: '/images/Большой проект. Пример/Page21.jpg' },
      { id: 23, type: 'image', alt: 'Сан Узел Вода + Канализация', src: '/images/Большой проект. Пример/Page22.jpg' },
      { id: 24, type: 'image', alt: 'Вид сверху Сан Узел', src: '/images/Большой проект. Пример/Page23.jpg' },
      { id: 25, type: 'image', alt: 'Сан узел 2 вода + канализация + электрика', src: '/images/Большой проект. Пример/Page24.jpg' },
      { id: 26, type: 'image', alt: 'Маленький Сан Узел мебель + вода + канализация', src: '/images/Большой проект. Пример/Page25.jpg' },
      { id: 27, type: 'image', alt: 'Электрика Сан Узел 2', src: '/images/Большой проект. Пример/Page26.jpg' },
      { id: 28, type: 'image', alt: 'Электрика морозильная камера', src: '/images/Большой проект. Пример/Page27.jpg' },
      { id: 29, type: 'image', alt: 'Вход в большой Сан Узел', src: '/images/Большой проект. Пример/Page28.jpg' },
      { id: 30, type: 'image', alt: 'Вход в большой Сан Узел', src: '/images/Большой проект. Пример/Page29.jpg' },
